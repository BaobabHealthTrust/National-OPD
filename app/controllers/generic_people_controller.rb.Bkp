    ...
    if params[:identifier]
      ...
      if found_person
        ...
        if params[:relation]
          ...
          DDEService.create_footprint(PatientService.get_patient(found_person).national_id, 'National-OPD')
    ...
    if !params[:identifier].blank? && !params[:given_name].blank? && !params[:family_name].blank?
      ...
      if params[:person][:id] != '0'
        ...
        if patient_id.length != 6 and create_from_dde_server
          ...
          DDEService.create_footprint(PatientService.get_patient(person).national_id, 'National-OPD')
